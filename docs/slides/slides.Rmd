...
- Pushes to Github `r ji('up arrow')`
...
Developer A is **.green[one commit behind]** Github. Pushing when not in-sync with the latest commits on Github creates the divergence. 
